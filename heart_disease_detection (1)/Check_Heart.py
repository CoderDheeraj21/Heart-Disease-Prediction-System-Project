...
def Train():
    ...
    def precation():
        ...
        call(['python','precation.py'])
        
    def back():
        from subprocess import call
        call(['python','Check_Heart.py'])
    ...
    def Detect():
        ...
        a1=load('dont delete model/HEART_DISEASE_MODEL.joblib')
        ...
        if v[0]==1:
            ...
            yes.place(x=200,y=160)
            yes = tk.Label(root,text="Don't smoke.\n Smoking is a major risk\n factor for heart disease,\n especially atherosclerosis.\n Report is Generated \n Eat healthy foods.\n Eat plenty of fruits, \n vegetables and whole grains \n Control blood pressure.\n Get a cholesterol test.\n Manage diabetes \n Exercise. \n Maintain a healthy weight \n Manage stress.",background="#8EB7FA",foreground="white",font=('times', 20, ' bold '),width=40)
            yes.place(x=700,y=200)
            ...
            button2 = tk.Button(root,text="Submit",command=precation,font=('times', 20, ' bold '),width=10, bg="black",fg="white")
            ...
            button2 = tk.Button(root,text="Submit",command=back,font=('times', 20, ' bold '),width=10, bg="black",fg="white")
            button2.place(x=600,y=200)
    ...
    monthchoosen = ttk.Combobox(frame_alpr, width = 10, textvariable = sex)
